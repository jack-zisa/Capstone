...
from utils.cloud_utils import get_user_data, get_user_by_uuid
import json
...
Using the demographic & health data tables, provide your conclusions for whether this person may be facing a medical issue. Respond only in a markdown table with the following columns: Issue Name, Issue Severity (low, medium, high), Issue Reasoning. Do not include any other explanation or text''')
